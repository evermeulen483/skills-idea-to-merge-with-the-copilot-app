...
1. When you're happy with it, **use agent merge to land `ROADMAP.md` on `main`**:
   ...
   <img width="440" alt="Session showing Agent merge landing ROADMAP.md on main — the pull request opened and merged automatically" src="https://github.com/evermeulen483/skills-idea-to-merge-with-the-copilot-app/blob/main/.github/images/ghcp-app-agent-merge.png?raw=true" />
   ...
   <img width="420" alt="Session action button showing 'Ready to merge' with the Agent merge toggle, ready to land ROADMAP.md on main" src="https://github.com/evermeulen483/skills-idea-to-merge-with-the-copilot-app/blob/main/.github/images/ghcp-app-ready-to-merge.png?raw=true" />

   Open the dropdown to confirm **Agent merge** is enabled and allowed to merge the pull request:

   <img width="440" alt="Session action dropdown with Agent merge enabled — the toggle on and 'Allow the agent to' listing Address reviews, Fix CI failures, Resolve conflicts, and Merge pull request" src="https://github.com/evermeulen483/skills-idea-to-merge-with-the-copilot-app/blob/main/.github/images/ghcp-app-allow-agent-merge.png?raw=true" />
